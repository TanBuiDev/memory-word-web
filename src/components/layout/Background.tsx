const Background = () => {
    return (
        <div className="fixed inset-0 -z-10 h-full w-full bg-white dark:bg-slate-950 transition-colors duration-300">
            ...
            <div className="absolute h-full w-full bg-[linear-linear(to_right,#8080800a_1px,transparent_1px),linear-linear(to_bottom,#8080800a_1px,transparent_1px)] bg-position-[24px_24px]"></div>
